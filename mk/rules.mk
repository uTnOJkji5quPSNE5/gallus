...
$(DEP_GALLUS_EVENT_WATCHER_LIB)::
	(cd $(BUILD_EVENTWATCHERDIR) && $(MAKE) $(GALLUS_EVENT_WATCHER_LIB))

$(DEP_GALLUS_CONNECTION_POOL_LIB)::
	(cd $(BUILD_CONNECTIONPOOLDIR) && $(MAKE) $(GALLUS_CONNECTION_POOL_LIB))

$(DEP_GALLUS_SENDER_LIB)::
	(cd $(BUILD_SENDERDIR) && $(MAKE) $(GALLUS_SENDER_LIB))

$(DEP_GALLUS_RECEIVER_LIB)::
	(cd $(BUILD_RECEIVERDIR) && $(MAKE) $(GALLUS_RECEIVER_LIB))

$(DEP_GALLUS_FILE_WRITER_LIB)::
	(cd $(BUILD_FILE_WRITERDIR) && $(MAKE) $(GALLUS_FILE_WRITER_LIB))

$(DEP_GALLUS_CONTROLLER_RECEIVER_LIB)::
	(cd $(BUILD_CONTROLLER_RECEIVERDIR) && $(MAKE) $(GALLUS_CONTROLLER_RECEIVER_LIB))

$(DEP_GALLUS_CONTROLLER_SEBDER_LIB)::
	(cd $(BUILD_CONTROLLER_SENDERDIR) && $(MAKE) $(GALLUS_CONTROLLER_SENDER_LIB))

$(DEP_GALLUS_NOTIFI_TBL_LIB)::
	(cd $(BUILD_NOTIFI_TBLDIR) && $(MAKE) $(GALLUS_NOTIFI_TBL_LIB))
